...
public class TitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("mysticcraft:titanium_ore", FEATURE,
				new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, MysticcraftModBlocks.TITANIUM_ORE.get().defaultBlockState(), 3));
		PLACED_FEATURE = PlacementUtils.register("mysticcraft:titanium_ore", CONFIGURED_FEATURE,
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("mysticcraft:titanium_ore_match"), CUSTOM_MATCH);
		}
