...
public class GoblinEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(MysticcraftModEntities.GOBLIN.get(), 20, 3, 20));
	}

	public GoblinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MysticcraftModEntities.GOBLIN.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(MysticcraftModEntities.GOBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
