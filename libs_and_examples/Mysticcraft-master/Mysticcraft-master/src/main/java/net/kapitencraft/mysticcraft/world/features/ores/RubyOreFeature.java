...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("mysticcraft:ruby_ore", FEATURE,
				new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, MysticcraftModBlocks.RUBY_ORE.get().defaultBlockState(), 3));
		PLACED_FEATURE = PlacementUtils.register("mysticcraft:ruby_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(5), InSquarePlacement.spread(),
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("mysticcraft:ruby_ore_match"), CUSTOM_MATCH);
		}
