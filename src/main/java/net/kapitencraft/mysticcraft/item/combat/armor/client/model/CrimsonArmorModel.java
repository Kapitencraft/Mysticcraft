...
public class CrimsonArmorModel extends ArmorModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorHead = partdefinition.addOrReplaceChild("armorHead", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.0F, -5.0F, 8.0F, 1.0F, 10.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition armorBody = partdefinition.addOrReplaceChild("armorBody", CubeListBuilder.create().texOffs(20, 26).addBox(-5.0F, 0.0F, -2.0F, 1.0F, 12.0F, 4.0F, CubeDeformation.NONE)
		...
		PartDefinition armorRightLeg = partdefinition.addOrReplaceChild("armorRightLeg", CubeListBuilder.create().texOffs(10, 41).addBox(2.0F, 0.0F, -2.0F, 1.0F, 9.0F, 4.0F, CubeDeformation.NONE)
		...
		PartDefinition armorRightBoot = partdefinition.addOrReplaceChild("armorRightBoot", CubeListBuilder.create().texOffs(0, 18).addBox(-3.0F, 11.0F, -3.0F, 6.0F, 1.0F, 6.0F, CubeDeformation.NONE), PartPose.offset(-2.0F, 12.0F, 0.0F));
		...
		PartDefinition armorLeftLeg = partdefinition.addOrReplaceChild("armorLeftLeg", CubeListBuilder.create().texOffs(40, 13).addBox(-3.0F, 0.0F, -2.0F, 1.0F, 9.0F, 4.0F, CubeDeformation.NONE)
		...
		PartDefinition armorLeftBoot = partdefinition.addOrReplaceChild("armorLeftBoot", CubeListBuilder.create().texOffs(0, 11).addBox(-3.0F, 11.0F, -3.0F, 6.0F, 1.0F, 6.0F, CubeDeformation.NONE), PartPose.offset(2.0F, 12.0F, 0.0F));
