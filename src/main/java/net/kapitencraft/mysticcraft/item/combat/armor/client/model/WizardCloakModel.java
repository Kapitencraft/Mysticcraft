...
public class WizardCloakModel extends ArmorModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorHead = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(52, 0).addBox(-4.0F, -8.0F, 4.0F, 8.0F, 8.0F, 1.0F, CubeDeformation.NONE)
		...
		PartDefinition armorBody = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(34, 0).addBox(-4.0F, -2.0F, 2.0F, 8.0F, 14.0F, 1.0F, CubeDeformation.NONE)
		...
		PartDefinition armorLeftArm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(10, 62).addBox(-1.0F, -2.0F, -3.0F, 4.0F, 11.0F, 1.0F, CubeDeformation.NONE)
		...
		PartDefinition armorRightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(0, 57).addBox(-3.0F, -2.0F, -3.0F, 4.0F, 11.0F, 1.0F, CubeDeformation.NONE)
		...
		PartDefinition armorLeftLeg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(54, 28).addBox(2.0F, -1.0F, 0.0F, 1.0F, 9.0F, 4.0F, CubeDeformation.NONE)
		...
		PartDefinition armorRightLeg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(54, 28).addBox(-3.0F, -1.0F, -2.0F, 1.0F, 9.0F, 4.0F, CubeDeformation.NONE)
		...
		PartDefinition armorLeftBoot = partdefinition.addOrReplaceChild("left_boot", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, 7.0F, 2.0F, 4.0F, 5.0F, 1.0F, CubeDeformation.NONE)
		...
		PartDefinition armorRightBoot = partdefinition.addOrReplaceChild("right_boot", CubeListBuilder.create().texOffs(52, 98).addBox(-2.0F, 7.0F, -3.0F, 4.0F, 5.0F, 1.0F, CubeDeformation.NONE)
