...
public class ShadowAssassinArmorModel extends ArmorModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorHead = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(14, 47).addBox(-4.5F, -8.5F, -4.5F, 9.0F, 8.5F, 0.0F, new CubeDeformation(0.0F))
		...
		.texOffs(8, 25).addBox(4.5F, -8.5F, -4.5F, 0.0F, 5.5F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
			...
			PartDefinition armorBody = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(44, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorLeftArm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(40, 8).addBox(-2.0F, -3.0F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorRightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(14, 40).addBox(-3.0F, -3.0F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorLeftLeg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(10, 50).addBox(-2.5F, 0.0F, -2.5F, 0.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorLeftBoot = partdefinition.addOrReplaceChild("left_boot", CubeListBuilder.create().texOffs(28, 18).addBox(-3.0F, 11.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorRightBoot = partdefinition.addOrReplaceChild("right_boot", CubeListBuilder.create().texOffs(27, 0).addBox(-3.0F, 11.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition armorRightLeg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(42, 46).addBox(2.5F, 0.0F, -2.5F, 0.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
