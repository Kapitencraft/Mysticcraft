...
public class FireBoldSpell extends Spell {
    ...
    public FireBoldSpell(double base_damage) {
    ...
    public void execute(LivingEntity user, ItemStack stack) {
        FireBoldProjectile projectile = FireBoldProjectile.createProjectile(user.level, user);
        projectile.shootFromRotation(user, user.getXRot(), user.getYRot(), 0, 10, 1);
