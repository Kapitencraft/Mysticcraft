...
public class MathUtils {
    ...
    public static List<BlockPos> makeLine(BlockPos a, BlockPos b, LineSize size) {
        ...
        MiscUtils.repeatXTimes(numPoints, integer -> {
    ...
    public static void forCube(BlockPos cube, TriConsumer<Integer, Integer, Integer> consumer) {
        MiscUtils.repeatXTimes(cube.getX(), integer -> MiscUtils.repeatXTimes(cube.getY(), integer1 -> MiscUtils.repeatXTimes(cube.getZ(), integer2 -> {
