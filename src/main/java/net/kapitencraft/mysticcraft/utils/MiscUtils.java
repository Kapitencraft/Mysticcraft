...
public class MiscUtils {
    ...
    public static boolean saveTeleportTest(Entity entity, double maxRange) {
        Vec3 targetPos = entity.getLookAngle().scale(maxRange).add(MathUtils.getPosition(entity));
        entity.move(MoverType.SELF, targetPos);
        return true;
    }

    public static boolean saveTeleport(Entity entity, double maxRange) {
        ArrayList<Vec3> lineOfSight = MathUtils.lineOfSight(entity, maxRange, 0.1);
        entity.stopRiding();
