...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        ...
        creatingArmor((ModArmorItem) ModItems.ENDER_KNIGHT_ARMOR_BOOTS.get());
        creatingArmor((ModArmorItem) ModItems.ENDER_KNIGHT_ARMOR_LEGGINGS.get());
        creatingArmor((ModArmorItem) ModItems.ENDER_KNIGHT_ARMOR_CHESTPLATE.get());
        creatingArmor((ModArmorItem) ModItems.ENDER_KNIGHT_ARMOR_HELMET.get());
    }
    ...
    private static void creatingArmor(ModArmorItem armorItem) {
