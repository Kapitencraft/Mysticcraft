...
public class SkeletonMasterModel extends HumanoidModel<SkeletonMaster> {
    public SkeletonMasterModel(ModelPart p_170941_) {
        super(p_170941_);
    }
    ...
    public void prepareMobModel(SkeletonMaster p_103793_, float p_103794_, float p_103795_, float p_103796_) {
    ...
    public void setupAnim(SkeletonMaster p_103798_, float p_103799_, float p_103800_, float p_103801_, float p_103802_, float p_103803_) {
