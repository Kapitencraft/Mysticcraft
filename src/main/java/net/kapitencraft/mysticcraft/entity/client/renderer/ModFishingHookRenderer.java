...
public class ModFishingHookRenderer extends EntityRenderer<ModFishingHook> {
    ...
    public ModFishingHookRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }

    @Override
    public ResourceLocation getTextureLocation(ModFishingHook p_114482_) {
        return TEXTURE_LOCATION;
    }

    public void render(ModFishingHook p_114705_, float p_114706_, float p_114707_, PoseStack p_114708_, MultiBufferSource p_114709_, int p_114710_) {
