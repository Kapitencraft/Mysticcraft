...
public class ReforgeProvider implements DataProvider {
    ...
    public void addReforges() {
        reforges.add(new Reforge.Builder("mythic")
                ...
                .addStat(ModAttributes.STRENGTH.get(), ReforgeStat.build(2., 4., 6., 8., 10., 12., 15.))
                .addStat(ModAttributes.CRIT_CHANCE.get(), ReforgeStat.build(0.5, 0.8, 1.1, 1.5, 1.9, 2.4, 3.))
                .addStat(Attributes.MOVEMENT_SPEED, ReforgeStat.build(2., 2., 2., 2., 2., 2., 2.))
                .addStat(ModAttributes.INTELLIGENCE.get(), ReforgeStat.build(15., 22., 30., 40., 52., 67., 90.))
                .build()
        );
        reforges.add(new Reforge.Builder("pure")
                ...
                .addStat(ModAttributes.CRIT_CHANCE.get(), ReforgeStat.build(1., 1.6, 2.2, 3.0, 3.8, 4.8, 6.))
                .addStat(ModAttributes.CRIT_DAMAGE.get(), ReforgeStat.build(2., 3., 4., 6., 8., 10., 13.))
                .addStat(Attributes.MOVEMENT_SPEED, ReforgeStat.build(1., 1., 1., 1., 1., 1., 1.))
                .addStat(ModAttributes.INTELLIGENCE.get(), ReforgeStat.build(2., 3., 5., 10., 17., 30., 45.))
                .addStat(ModAttributes.BONUS_ATTACK_SPEED.get(), ReforgeStat.build(1., 1., 1.5, 2.1, 3., 4.1, 5.5))
                .build()
        );
        ...
        reforges.add(Reforge.builder("smart")
                ...
                .addStat(ModAttributes.INTELLIGENCE.get(), ReforgeStat.build(20., 40., 60., 80., 100., 130., 165.))
                .build()
        );
        reforges.add(Reforge.builder("wise")
                ...
                .addStat(ModAttributes.INTELLIGENCE.get(), ReforgeStat.build(30., 50., 80., 110., 145., 190., 250.))
                .build()
        );
    }
}
