...
public enum OverlayLocations implements OverlayLocation {
    MANA("589c7ac3-4dc1-487b-b4b8-90524ce97bdc", new PositionHolder( 2f, 5, 1, 1, PositionHolder.Alignment.TOP_LEFT, PositionHolder.Alignment.TOP_LEFT)),
    STATS("cf4eb19d-aec8-4e65-8b43-c5e573b4561b", new PositionHolder(-183, 21, .75f, .75f, PositionHolder.Alignment.MIDDLE, PositionHolder.Alignment.BOTTOM_RIGHT));
