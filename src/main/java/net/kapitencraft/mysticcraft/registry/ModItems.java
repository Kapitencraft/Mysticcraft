...
public interface ModItems {
    ...
    RegistryObject<WalletItem> WALLET = register("wallet", WalletItem::new, TabGroups.MATERIAL);
    RegistryObject<EssenceItem> ESSENCE = register("essence", EssenceItem::new, null);
    RegistryObject<VoidTotemItem> VOID_TOTEM_ITEM = register("void_totem", VoidTotemItem::new, TabGroups.COMBAT);
    RegistryObject<ModDebugStickItem> MOD_DEBUG_STICK = register("mod_debug_stick", ModDebugStickItem::new, TabGroups.UTILITIES);
    RegistryObject<BuildersWand> BUILDERS_WAND = register("builders_wand", BuildersWand::new, TabGroups.UTILITIES);

    //region Weaponry
    RegistryObject<RainbowSwordItem> RAINBOW_SWORD = register("rainbow_sword", RainbowSwordItem::new, TabGroups.COMBAT);
    RegistryObject<DarkDagger> DARK_DAGGER = register("dark_dagger", DarkDagger::new, TabGroups.COMBAT);
    ...
    RegistryObject<GhostlySword> GHOSTLY_SWORD = register("ghostly_sword", GhostlySword::new, TabGroups.COMBAT);
    ...
    RegistryObject<ShadowDagger> SHADOW_DAGGER = register("shadow_dagger", ShadowDagger::new, TabGroups.COMBAT);
    //endregion
    ...
    RegistryObject<MaterialModItem> ORB_OF_CONSUMPTION = registerNonStackableMaterial("orb_of_consumption", Rarity.EPIC, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> NECRONS_HANDLE = registerNonStackableMaterial("necrons_handle", ExtraRarities.LEGENDARY, TabGroups.MATERIAL);
    RegistryObject<SouldbindNucleus> SOULBOUND_CORE = register("soulbound_nucleus", SouldbindNucleus::new, TabGroups.MATERIAL);
    RegistryObject<UnbreakingCore> UNBREAKING_CORE = register("unbreaking_core", UnbreakingCore::new, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> MANA_STEEL_INGOT = registerMaterial("mana_steel_ingot", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> MS_UPPER_BlADE = registerNonStackableMaterial("upper_mana_steel_blade", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> MS_DOWN_BlADE = registerNonStackableMaterial("lower_mana_steel_blade", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> MS_HANDLE = registerNonStackableMaterial("mana_steel_sword_handle", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> HEART_OF_THE_NETHER = registerNonStackableMaterial("heart_of_the_nether", ExtraRarities.MYTHIC, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> CRIMSON_STEEL_INGOT = registerMaterial("crimson_steel_ingot", Rarity.EPIC, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> TERROR_STEEL_INGOT = registerMaterial("terror_steel_ingot", Rarity.EPIC, TabGroups.TERROR_MATERIAL);
    RegistryObject<MaterialModItem> CRIMSON_STEEL_DUST = registerMaterial("crimson_steel_dust", Rarity.EPIC, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> CRIMSONITE_CLUSTER = registerMaterial("crimsonite_cluster", Rarity.UNCOMMON, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> CRIMSONITE_DUST = registerMaterial("crimsonite_dust", Rarity.RARE, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> CRIMSONIUM_DUST = registerMaterial("crimsonium_dust", Rarity.RARE, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> CRIMSONIUM_INGOT = registerMaterial("crimsonium_ingot", Rarity.RARE, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> RAW_CRIMSONIUM = registerMaterial("raw_crimsonium", Rarity.UNCOMMON, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> RAW_CRIMSONIUM_DUST = registerMaterial("raw_crimsonium_dust", Rarity.RARE, TabGroups.CRIMSON_MATERIAL);
    RegistryObject<MaterialModItem> HARDENED_TEAR = registerMaterial("hardened_tear", Rarity.UNCOMMON, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> LAPIS_DUST = registerMaterial("lapis_dust", Rarity.COMMON, TabGroups.MATERIAL);
    ...
    RegistryObject<MaterialModItem> FROZEN_BLAZE_ROD = registerMaterial("frozen_blaze_rod", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> SOUL_STEEL_ALLOY = registerMaterial("soul_steel_alloy", Rarity.RARE, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> SOUL_STEEL_NUGGET = registerMaterial("soul_steel_nugget", Rarity.UNCOMMON, TabGroups.MATERIAL);
    RegistryObject<MaterialModItem> SHADOW_CRYSTAL = registerMaterial("shadow_crystal", Rarity.UNCOMMON, TabGroups.MATERIAL);
    RegistryObject<DyedLeatherItem> DYED_LEATHER = register("dyed_leather",  DyedLeatherItem::new, TabGroups.MATERIAL);
    //endregion
    ...
    RegistryObject<LavaFishingRod> LAVA_FISHING_ROD_TEST = register("lava_fishing_rod", () -> new LavaFishingRod(Rarity.RARE), TabGroups.MATERIAL);
    ...
    RegistryObject<TravelersBoots> TRAVELERS_BOOTS = register("travelers_boots", TravelersBoots::new, TabGroups.COMBAT);
    RegistryObject<WizardHatItem> WIZARD_HAT = register("wizard_hat", WizardHatItem::new, ModBowItem.BOW_GROUP);

    Map<ArmorItem.Type, RegistryObject<EnderKnightArmorItem>> ENDER_KNIGHT_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "ender_knight", EnderKnightArmorItem::new, EnderKnightArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<FrozenBlazeArmorItem>> FROZEN_BLAZE_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "frozen_blaze", FrozenBlazeArmorItem::new, FrozenBlazeArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<ShadowAssassinArmorItem>> SHADOW_ASSASSIN_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "shadow_assassin", ShadowAssassinArmorItem::new, ShadowAssassinArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<CrimsonArmorItem>> CRIMSON_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "crimson", CrimsonArmorItem::new, CrimsonArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<SoulMageArmorItem>> SOUL_MAGE_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "soul_mage", SoulMageArmorItem::new, SoulMageArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<WizardCloakArmorItem>> WIZARD_CLOAK_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "wizard_cloak", WizardCloakArmorItem::new, WizardCloakArmorItem.TAB);
    Map<ArmorItem.Type, RegistryObject<TerrorArmorItem>> TERROR_ARMOR = AbstractArmorItem.createRegistry(REGISTRY, "terror", TerrorArmorItem::new, TerrorArmorItem.TAB);

    //endregion

    //region spawn eggs
    RegistryObject<Item> FROZEN_BLAZE_SPAWN_EGG = register("frozen_blaze_spawn_egg", ()-> new ForgeSpawnEggItem(ModEntityTypes.FROZEN_BLAZE, -16711681, -16763956, new Item.Properties()), TabGroups.SPAWN_EGGS);
    RegistryObject<Item> DRAGON_SPAWN_EGG = register("dragon_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.DRAGON, 0xFF4F0000, 0xFFFF0000, new Item.Properties()), TabGroups.SPAWN_EGGS);
    //endregion
    ...
    RegistryObject<CursedPearlItem> CURSED_PEARL = register("cursed_pearl", CursedPearlItem::new, TabGroups.COMBAT);

    //region tech
    RegistryObject<TechWandItem> TECH_WAND = register("tech_wand", TechWandItem::new, TabGroups.TECHNOLOGY);

    RegistryObject<ParallelProcessingUpgradeItem> PARALLEL_PROCESSING_UPGRADE = register("upgrade/parallel_processing", ParallelProcessingUpgradeItem::new, TabGroups.TECHNOLOGY);
    RegistryObject<SpeedUpgradeItem> SPEED_UPGRADE = register("upgrade/speed", SpeedUpgradeItem::new, TabGroups.TECHNOLOGY);
    //endregion
}