...
public class MysticcraftMod {
    ...
    public static final UUID ITEM_ATTRIBUTE_MODIFIER_ADD = UUID.fromString("7be43dcd-084a-49d6-91d7-280777b49926");
    public static final UUID ITEM_ATTRIBUTE_MODIFIER_MUL = UUID.fromString("47bcd762-0959-4385-aee8-fa5d6f92c31f");
