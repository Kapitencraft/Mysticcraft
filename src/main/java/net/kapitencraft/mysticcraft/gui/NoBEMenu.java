...
public abstract class NoBEMenu<T extends Container> extends AbstractContainerMenu {
    ...
    protected NoBEMenu(@Nullable MenuType<?> pMenuType, int pContainerId, T container, Level level, Player player, ContainerLevelAccess access) {
        super(pMenuType, pContainerId);
        this.container = container;
        this.slotAmount = container.getContainerSize();
        this.level = level;
        this.player = player;
        this.access = access;
    }
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(access, pPlayer, getBlock());
    }
