...
import net.kapitencraft.mysticcraft.item.combat.spells.necron_sword.Hyperion;
import net.kapitencraft.mysticcraft.item.combat.spells.necron_sword.Scylla;
import net.kapitencraft.mysticcraft.item.combat.spells.necron_sword.Valkyrie;
