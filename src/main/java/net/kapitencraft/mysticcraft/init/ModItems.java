...
import net.kapitencraft.mysticcraft.item.VillagerFleshItem;
...
public abstract class ModItems {
    ...
    public static final RegistryObject<Item> VILLAGER_FLESH = REGISTRY.register("villager_flesh", VillagerFleshItem::new);
