...
public class ModFluids {
    ...
    private static final ForgeFlowingFluid.Properties MANA_FLUID_PROPERTIES = new ForgeFlowingFluid.Properties(ModFluidTypes.MANA_FLUID_TYPE, SOURCE_MANA_FLUID, FLOWING_MANA_FLUID).levelDecreasePerBlock(1).slopeFindDistance(8).block(ModBlocks.MANA_FLUID_BLOCK);
