...
public abstract class ModAttributes {
    ...
    public static final RegistryObject<Attribute> ABILLITY_DAMAGE = REGISTRY.register("generic.ability_damage", () -> new RangedAttribute(FormattingCodes.RED.UNICODE + "Ability Damage", 0D, 0D, 1000.0D).setSyncable(true));
