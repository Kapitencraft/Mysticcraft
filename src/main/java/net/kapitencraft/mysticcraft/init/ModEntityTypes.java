...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<SkeletonMaster>> SKELETON_MASTER = REGISTRY.register("skeleton_master", ()-> EntityType.Builder.of(SkeletonMaster::new, MobCategory.MONSTER).sized(0.6F, 1.99F).build(new ResourceLocation(MysticcraftMod.MOD_ID, "skeleton_master").toString()));
}