...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<ModFishingHook>> MOD_FISHING_HOOK = REGISTRY.register("mod_fishing", ()-> EntityType.Builder.of(ModFishingHook::new, MobCategory.MISC).sized(0.25f, 0.25f).build(new ResourceLocation(MysticcraftMod.MOD_ID, "mod_fishing_hook").toString()));
