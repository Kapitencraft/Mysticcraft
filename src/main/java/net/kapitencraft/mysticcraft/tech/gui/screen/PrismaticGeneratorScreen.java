...
public class PrismaticGeneratorScreen extends BlockEntityScreen<PrismaticGeneratorBlockEntity, PrismaticGeneratorMenu> {

    public PrismaticGeneratorScreen(PrismaticGeneratorMenu menu, Inventory inventory, Component title) {
    ...
    public ResourceLocation getTexture() {
        return MysticcraftMod.res("textures/gui/prismatic_generator.png");
    }
}
