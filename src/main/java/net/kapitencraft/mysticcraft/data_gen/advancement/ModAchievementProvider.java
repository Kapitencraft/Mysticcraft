...
public class ModAchievementProvider extends ForgeAdvancementProvider {

    public ModAchievementProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, ExistingFileHelper existingFileHelper) {
