...
public class ReforgeProvider implements DataProvider {
    ...
    public void addReforges() {
        ...
        add("fair", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 2, 3, 4, 7, 10, 15, 23)
        ...
        add("heroic", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 40, 50, 65, 80, 100, 125, 154)
        ...
        add("legendary", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 5, 8, 12, 18, 25, 35, 48)
        ...
        add("odd", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, -5, -10, -18, -32, -50, -72, -110)
        );
        ...
        add("awkward", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, -5, -10, -18, -32, -50, -72, -100)
        ...
        add("neat", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 3, 5, 6, 12, 20, 30, 45)
        );
        ...
        add("rich", new Reforge.Builder()
                ...
                .addStat(ExtraAttributes.CRIT_CHANCE, 10, 12, 14, 17, 20, 25, 32)
                .addStat(ExtraAttributes.CRIT_DAMAGE, 2, 4, 7, 10, 15, 20, 27)
                .addStat(ManaAttributes.MAX_MANA, 3, 5, 6, 12, 20, 30, 42)
        );
        ...
        add("mythic", new Reforge.Builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 15., 22., 30., 40., 52., 67., 90.)
        );
        add("pure", new Reforge.Builder()
                ...
                .addStat(Attributes.MOVEMENT_SPEED, 1., 1., 1., 1., 1., 1., 1.)
                .addStat(ManaAttributes.MAX_MANA, 2., 3., 5., 10., 17., 30., 45.)
        ...
        add("smart", Reforge.builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 20., 40., 60., 80., 100., 130., 165.)
        );
        ...
        add("wise", Reforge.builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 30., 50., 80., 110., 145., 190., 250.)
        );
        //endregion
        //region equipment
        add("astute", Reforge.builder()
                ...
                .addStat(ManaAttributes.MAX_MANA, 3, 4, 5, 6, 8, 10, 10)
        );
